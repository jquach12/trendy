  ...
  render() {
    return (
      <div className="blog">
        ...
        <h3> Some Thoughts on the Future of News Consumerism </h3>
        <div className="text"> I personally feel that the world has gotten a lot noisier with articles being written by people and generated by bots left and right. I hope we as good citizens of the world tackle this growing problem as it will only get harder to discern the useful (accurate) information if we let the news continue to spread as it is now. I am hopeful that one day that type of spread will permeate in our public education system.</div>
        <br></br>
        <h5> -Jonathan Q</h5>
      </div>
    )
